...
cat << "key" > "`pwd`/configure/自定义.prop"
#蓝奏云
...
cat << "key" > "`pwd`/configure/广告奖励.prop"
adsmind.gdtimg.com
c.gdt.qq.com
d.gdt.qq.com
gw.365you.com
...
cat << "key" > "`pwd`/configure/保留奖励.prop"
adsmind.gdtimg.com
c.gdt.qq.com
d.gdt.qq.com
gw.365you.com
...
cat << "key" > "`pwd`/configure/排除列表.prop"
#host屏蔽的域名
#X5内核
...
if test -e "${file}" ;then 
	mkdir -p "${targetdir}"
	hosts_value="$(cat "${file}" | grep "$word" "${value}" "${file}" | sed '/^#/d;/^[[:space:]]*$/d' )"
echo "${hosts_value}" > "${targetdir}/${value}.conf" && echo "已经输出[ $value ]"
key
fi
}
...
dos2unix *
dos2unix */*
grep_value_file "1" '1688' "`pwd`/host"
grep_value_file "1" '2345' "`pwd`/host"
grep_value_file "1" '360' "`pwd`/host"
grep_value_file "1" '360safe' "`pwd`/host"
grep_value_file "1" '365' "`pwd`/host"
grep_value_file "1" 'JUNKY' "`pwd`/host"
grep_value_file "1" 'TRAFFIC' "`pwd`/host"
grep_value_file "1" 'TRAFFIC.*JUNKY' "`pwd`/host"
grep_value_file "1" '[[:alpha:]]ad' "`pwd`/host"
grep_value_file "1" '[[:alpha:]]ads' "`pwd`/host"
grep_value_file "1" '[[:alpha:]]cdn' "`pwd`/host"
grep_value_file "1" '[[:alpha:]]sdk' "`pwd`/host"
grep_value_file "1" '[[:digit:]]ad' "`pwd`/host"
grep_value_file "1" '[[:digit:]]ads' "`pwd`/host"
grep_value_file "1" 'ad' "`pwd`/host"
grep_value_file "1" 'ad.*cdn' "`pwd`/host"
grep_value_file "1" 'ad.*service' "`pwd`/host"
grep_value_file "1" 'ad.*services' "`pwd`/host"
grep_value_file "1" 'ad[[:alpha:]]' "`pwd`/host"
grep_value_file "1" 'ad[[:alpha:]][[:digit:]]' "`pwd`/host"
grep_value_file "1" 'ad[[:digit:]]' "`pwd`/host"
grep_value_file "1" 'adapi' "`pwd`/host"
grep_value_file "1" 'adbana' "`pwd`/host"
grep_value_file "1" 'adimg' "`pwd`/host"
grep_value_file "1" 'adjust' "`pwd`/host"
grep_value_file "1" 'adkwai' "`pwd`/host"
grep_value_file "1" 'admaster' "`pwd`/host"
grep_value_file "1" 'adnxs' "`pwd`/host"
grep_value_file "1" 'adobe' "`pwd`/host"
grep_value_file "1" 'adpush' "`pwd`/host"
grep_value_file "1" 'ads' "`pwd`/host"
grep_value_file "1" 'ads.*cdn' "`pwd`/host"
grep_value_file "1" 'ads[[:alpha:]][[:digit:]]' "`pwd`/host"
grep_value_file "1" 'ads[[:digit:]]' "`pwd`/host"
grep_value_file "1" 'adsage' "`pwd`/host"
grep_value_file "1" 'adsame' "`pwd`/host"
grep_value_file "1" 'adsapi' "`pwd`/host"
grep_value_file "1" 'adsdk' "`pwd`/host"
grep_value_file "1" 'adsensor' "`pwd`/host"
grep_value_file "1" 'adsmind' "`pwd`/host"
grep_value_file "1" 'adtrack' "`pwd`/host"
grep_value_file "1" 'advertise' "`pwd`/host"
grep_value_file "1" 'advertisement' "`pwd`/host"
grep_value_file "1" 'advertising' "`pwd`/host"
grep_value_file "1" 'adview' "`pwd`/host"
grep_value_file "1" 'adwo' "`pwd`/host"
grep_value_file "1" 'agrantsem' "`pwd`/host"
grep_value_file "1" 'alicdn' "`pwd`/host"
grep_value_file "1" 'alimama' "`pwd`/host"
grep_value_file "1" 'analytics' "`pwd`/host"
grep_value_file "1" 'api' "`pwd`/host"
grep_value_file "1" 'appad' "`pwd`/host"
grep_value_file "1" 'appads' "`pwd`/host"
grep_value_file "1" 'atianqi' "`pwd`/host"
grep_value_file "1" 'baichuan' "`pwd`/host"
grep_value_file "1" 'baidu' "`pwd`/host"
grep_value_file "1" 'banner' "`pwd`/host"
grep_value_file "1" 'bcebos' "`pwd`/host"
grep_value_file "1" 'bdimg' "`pwd`/host"
grep_value_file "1" 'bdstatic' "`pwd`/host"
grep_value_file "1" 'browser' "`pwd`/host"
grep_value_file "1" 'bugly' "`pwd`/host"
grep_value_file "1" 'cdn.*ad' "`pwd`/host"
grep_value_file "1" 'cdn.*ads' "`pwd`/host"
grep_value_file "1" 'check' "`pwd`/host"
grep_value_file "1" 'cibntv' "`pwd`/host"
grep_value_file "1" 'click' "`pwd`/host"
grep_value_file "1" 'cnzz' "`pwd`/host"
grep_value_file "1" 'commercial' "`pwd`/host"
grep_value_file "1" 'consumer' "`pwd`/host"
grep_value_file "1" 'corp' "`pwd`/host"
grep_value_file "1" 'cpro' "`pwd`/host"
grep_value_file "1" 'csdn' "`pwd`/host"
grep_value_file "1" 'ctobsnssdk' "`pwd`/host"
grep_value_file "1" 'dm' "`pwd`/host"
grep_value_file "1" 'dns' "`pwd`/host"
grep_value_file "1" 'douban' "`pwd`/host"
grep_value_file "1" 'doubanio' "`pwd`/host"
grep_value_file "1" 'doubleclick' "`pwd`/host"
grep_value_file "1" 'download' "`pwd`/host"
grep_value_file "1" 'exosrv' "`pwd`/host"
grep_value_file "1" 'flash' "`pwd`/host"
grep_value_file "1" 'flurry' "`pwd`/host"
grep_value_file "1" 'gdt' "`pwd`/host"
grep_value_file "1" 'gifshow' "`pwd`/host"
grep_value_file "1" 'godaddy' "`pwd`/host"
grep_value_file "1" 'google' "`pwd`/host"
grep_value_file "1" 'googlead' "`pwd`/host"
grep_value_file "1" 'googleads' "`pwd`/host"
grep_value_file "1" 'googleanalysis' "`pwd`/host"
grep_value_file "1" 'googlesyndication' "`pwd`/host"
grep_value_file "1" 'gtimg' "`pwd`/host"
grep_value_file "1" 'hao123' "`pwd`/host"
grep_value_file "1" 'heytap.*' "`pwd`/host"
grep_value_file "1" 'httpdns' "`pwd`/host"
grep_value_file "1" 'igexin' "`pwd`/host"
grep_value_file "1" 'imgad' "`pwd`/host"
grep_value_file "1" 'imgcache' "`pwd`/host"
grep_value_file "1" 'imtt' "`pwd`/host"
grep_value_file "1" 'ipinyou' "`pwd`/host"
grep_value_file "1" 'iqiyi' "`pwd`/host"
grep_value_file "1" 'ixigua' "`pwd`/host"
grep_value_file "1" 'jiguang' "`pwd`/host"
grep_value_file "1" 'jomodns' "`pwd`/host"
grep_value_file "1" 'juicy' "`pwd`/host"
grep_value_file "1" 'ksapisrv' "`pwd`/host"
grep_value_file "1" 'ksosoft' "`pwd`/host"
grep_value_file "1" 'kuaishou' "`pwd`/host"
grep_value_file "1" 'kwad' "`pwd`/host"
grep_value_file "1" 'lenovomm' "`pwd`/host"
grep_value_file "1" 'lianmeng' "`pwd`/host"
grep_value_file "1" 'lmgg' "`pwd`/host"
grep_value_file "1" 'locus' "`pwd`/host"
grep_value_file "1" 'lottery' "`pwd`/host"
grep_value_file "1" 'lrswl' "`pwd`/host"
grep_value_file "1" 'mediav' "`pwd`/host"
grep_value_file "1" 'meitu' "`pwd`/host"
grep_value_file "1" 'mi' "`pwd`/host"
grep_value_file "1" 'miaozhen' "`pwd`/host"
grep_value_file "1" 'migu' "`pwd`/host"
grep_value_file "1" 'miguvideo' "`pwd`/host"
grep_value_file "1" 'miui' "`pwd`/host"
grep_value_file "1" 'mmstat' "`pwd`/host"
grep_value_file "1" 'mob' "`pwd`/host"
grep_value_file "1" 'mobad' "`pwd`/host"
grep_value_file "1" 'mobads' "`pwd`/host"
grep_value_file "1" 'mobi' "`pwd`/host"
grep_value_file "1" 'mobilead' "`pwd`/host"
grep_value_file "1" 'mobileads' "`pwd`/host"
grep_value_file "1" 'mobmore' "`pwd`/host"
grep_value_file "1" 'msn' "`pwd`/host"
grep_value_file "1" 'mssdk' "`pwd`/host"
grep_value_file "1" 'mta' "`pwd`/host"
grep_value_file "1" 'netease' "`pwd`/host"
grep_value_file "1" 'oceanengine' "`pwd`/host"
grep_value_file "1" 'open' "`pwd`/host"
grep_value_file "1" 'openapi' "`pwd`/host"
grep_value_file "1" 'oppo' "`pwd`/host"
grep_value_file "1" 'oppomobile' "`pwd`/host"
grep_value_file "1" 'oupeng' "`pwd`/host"
grep_value_file "1" 'pagead' "`pwd`/host"
grep_value_file "1" 'pagead[[:digit:]]' "`pwd`/host"
grep_value_file "1" 'pandora' "`pwd`/host"
grep_value_file "1" 'pangle' "`pwd`/host"
grep_value_file "1" 'partner' "`pwd`/host"
grep_value_file "1" 'pgdt' "`pwd`/host"
grep_value_file "1" 'pglstatp' "`pwd`/host"
grep_value_file "1" 'pinduoduo' "`pwd`/host"
grep_value_file "1" 'pro' "`pwd`/host"
grep_value_file "1" 'pstatp' "`pwd`/host"
grep_value_file "1" 'puata' "`pwd`/host"
grep_value_file "1" 'qihoo' "`pwd`/host"
grep_value_file "1" 'qq' "`pwd`/host"
grep_value_file "1" 'realsrv' "`pwd`/host"
grep_value_file "1" 'sax' "`pwd`/host"
grep_value_file "1" 'saxs' "`pwd`/host"
grep_value_file "1" 'sdk' "`pwd`/host"
grep_value_file "1" 'share' "`pwd`/host"
grep_value_file "1" 'shifen' "`pwd`/host"
grep_value_file "1" 'sina' "`pwd`/host"
grep_value_file "1" 'sinaimg' "`pwd`/host"
grep_value_file "1" 'sm' "`pwd`/host"
grep_value_file "1" 'smartadserver' "`pwd`/host"
grep_value_file "1" 'snssdk' "`pwd`/host"
grep_value_file "1" 'splash' "`pwd`/host"
grep_value_file "1" 'syndication' "`pwd`/host"
grep_value_file "1" 'tad' "`pwd`/host"
grep_value_file "1" 'tagtic' "`pwd`/host"
grep_value_file "1" 'talkingdata' "`pwd`/host"
grep_value_file "1" 'taobao' "`pwd`/host"
grep_value_file "1" 'taobaocdn' "`pwd`/host"
grep_value_file "1" 'tbs' "`pwd`/host"
grep_value_file "1" 'tieba' "`pwd`/host"
grep_value_file "1" 'tongji' "`pwd`/host"
grep_value_file "1" 'top' "`pwd`/host"
grep_value_file "1" 'tos' "`pwd`/host"
grep_value_file "1" 'toutiao' "`pwd`/host"
grep_value_file "1" 'tpns' "`pwd`/host"
grep_value_file "1" 'trace' "`pwd`/host"
grep_value_file "1" 'twitter' "`pwd`/host"
grep_value_file "1" 'uc' "`pwd`/host"
grep_value_file "1" 'ucweb' "`pwd`/host"
grep_value_file "1" 'uczzd' "`pwd`/host"
grep_value_file "1" 'umeng' "`pwd`/host"
grep_value_file "1" 'umengcloud' "`pwd`/host"
grep_value_file "1" 'union' "`pwd`/host"
grep_value_file "1" 'update' "`pwd`/host"
grep_value_file "1" 'upgrade' "`pwd`/host"
grep_value_file "1" 'vlion' "`pwd`/host"
grep_value_file "1" 'voiceads' "`pwd`/host"
grep_value_file "1" 'wechat' "`pwd`/host"
grep_value_file "1" 'weibo' "`pwd`/host"
grep_value_file "1" 'weixin' "`pwd`/host"
grep_value_file "1" 'woozooo' "`pwd`/host"
grep_value_file "1" 'wps' "`pwd`/host"
grep_value_file "1" 'wx' "`pwd`/host"
grep_value_file "1" 'wxs' "`pwd`/host"
grep_value_file "1" 'wxsnsdy' "`pwd`/host"
grep_value_file "1" 'x5' "`pwd`/host"
grep_value_file "1" 'xdrig' "`pwd`/host"
grep_value_file "1" 'xg' "`pwd`/host"
grep_value_file "1" 'ximalaya' "`pwd`/host"
grep_value_file "1" 'xiaomi' "`pwd`/host"
grep_value_file "1" 'xigua' "`pwd`/host"
grep_value_file "1" 'xunlei' "`pwd`/host"
grep_value_file "1" 'youdao' "`pwd`/host"
grep_value_file "1" 'yximgs' "`pwd`/host"
grep_value_file "1" 'zhihu' "`pwd`/host"
grep_value_file "1" 'zijieapi' "`pwd`/host"
grep_value_file "1" 'zzd' "`pwd`/host"

add_custo `pwd`/configure/自定义.prop `pwd`/result
add_custo `pwd`/configure/魅族.conf `pwd`/result
remove_ad `pwd`/configure/配置/广告奖励.prop `pwd`/result/广告奖励.conf `pwd`/all
